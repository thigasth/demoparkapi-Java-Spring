...
public class VagaIT {
    ...
    @Test
    public void criarVaga_DadosInvalidos_RetornarErrorMessageComStatus422() {
        testClient
                .post()
                .uri("/api/v1/vagas")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void buscarVaga_ComUsuarioSemPermissaoDeAcesso_RetornarVagaComStatus403() {
        testClient
                .get()
                .uri("/api/v1/vagas/{codigo}", "A-01")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "bia@gmail.com", "123456"))
    ...
    @Test
    public void buscarVaga_ComCoigoInexistente_RetornarErrorMessageComStatus404() {
        testClient
                .get()
