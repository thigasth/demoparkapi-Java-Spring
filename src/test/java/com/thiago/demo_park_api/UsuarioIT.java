...
public class UsuarioIT {
    ...
    @Test
    public void createUsuario_ComPasswordIValido_RetornarErrorMessageSatus422() {
        ErrorMessage responseBody = testClient
                .post()
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioCreateDto("tody@emai.com", ""))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    @Test
    public void createUsuario_ComUsernameRepetido_RetornarErrorMessageSatus409() {
            ErrorMessage responseBody = testClient
                .post()
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void buscarUsuario_ComIdExistente_RetornarComStatus200() {
        UsuarioResponseDto responseBody = testClient
                .get()
    ...
    @Test
    public void buscarLista_ComTodosUsuarios_RetornarListaComStatus200() {
