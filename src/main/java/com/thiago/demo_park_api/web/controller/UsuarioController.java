...
@Tag(name = "Usuários", description = "Contem todas as operacões relativas aos recursos para cadastro, edicão e leitura de um usuário.")
...
public class UsuarioController {
    ...
    @Operation( summary = "Recuperar um usuário pelo id", description = "Requisicão exige um Bearer Token. Acesso restrito a ADMIN ou CLIENTE",
            security = @SecurityRequirement(name = "security"),
            responses = {
                    @ApiResponse(responseCode = "200", description = "Recurso recuperado com sucesso",
                            content = @Content(mediaType = "application/json", schema = @Schema(implementation = UsuarioResponseDto.class))),
                    @ApiResponse(responseCode = "403", description = "Usuario sem permissão para aceesar este recurso",
                            content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorMessage.class))),
    ...
    @Operation( summary = "Atualizar senha", description = "Requisicão exige um Bearer Token. Acesso restrito a ADMIN ou CLIENTE",
            security = @SecurityRequirement(name = "security"),
            responses = {
    ...
    @Operation( summary = "Listar todos os usuários cadastrados", description = "Requisicão exige um Bearer Token. Acesso restrito a ADMIN",
            security = @SecurityRequirement(name = "security"),
            responses = {
