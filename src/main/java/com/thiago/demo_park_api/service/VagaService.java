...
import com.thiago.demo_park_api.exception.CodigoUniqueViolateException;
import com.thiago.demo_park_api.exception.EntityNotFoundException;
import com.thiago.demo_park_api.repository.VagaRepository;
import lombok.RequiredArgsConstructor;
import org.springframework.dao.DataIntegrityViolationException;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;

import static com.thiago.demo_park_api.entity.Vaga.StatusVaga.LIVRE;
...
public class VagaService {
    ...
    public Vaga salvar(Vaga vaga) {
        try {
            ...
            throw new CodigoUniqueViolateException(String.format("Vaga com código '%s ' já cadastrada", vaga.getCodigo())
            );
        }
    }
